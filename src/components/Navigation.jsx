...
const Navigation = () => {
  return (
    <div className="w-4/5 m-auto flex justify-between items-center border border-black" >
        ...
        <div className="nav-middle">
            <ul className="border border-black flex justify-between items-center gap-10">
                <li>HOME</li>
                <li>FEATURES</li>
                <li>CATEGORIES</li>
                <li>CONTACT US</li>
